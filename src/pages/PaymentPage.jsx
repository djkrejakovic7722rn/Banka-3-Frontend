...
export default function PaymentPage() {
  ...
  function validate() {
    ...
    const normalizedRecipient = normalizeAccountNumberInput(form.recipient_account);

    if (form.recipient_account === "") {
      errs.recipient_account = "Unesite račun primaoca.";
    } else if (!isValidAccountNumber(normalizedRecipient)) {
  ...
  async function handleTotpConfirm(totpCode) {
    ...
    try {
      ...
      const invalidTotp = isInvalidTotpError(err);
